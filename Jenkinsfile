    ...
    stages {
        stage('Preparation') { 
            ...
            steps{
                ...
                git branch: 'main', url: 'https://github.com/shaima-99/devops-playground.git'
            }
        ...
        stage('Docker Build') {
            ...
            steps {
                ...
                bat 'docker build -t shaima-99/devops-playground:latest .' 
            }
        }
        stage("Testing"){
            ...
            steps{
                ...
                bat 'docker run -d --name docker-devops-playground --publish 8088:8088 shaima-99/devops-playground'
        ...
        stage('Docker Push') {
            ...
            steps {
                ...
                bat 'docker push shaima-99/devops-playground:latest'
                }
            }
        }
        stage("Update Jira"){
